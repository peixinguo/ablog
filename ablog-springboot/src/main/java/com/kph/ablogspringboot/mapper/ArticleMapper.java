...
import com.kph.ablogspringboot.model.dto.ConditionDTO;
import com.kph.ablogspringboot.model.vo.*;
...
public interface ArticleMapper extends BaseMapper<Article> {
     ...
     * @return 文章数量
     */
    Long countArticleBackVO(@Param("condition") ConditionDTO conditionDTO );
